...
<svelte:head>
  <!-- Primary Meta Tags -->
  <title>Building the most visually distinct set of colors</title>
  <meta name="title" content="Building the most visually distinct set of colors" />
  <meta
    name="description"
    content="Learning about colorspaces, perceptual uniformity, and creating nice sets of colors for visualizations."
  />

  <!-- Open Graph / Facebook -->
  <meta property="og:type" content="website" />
  <meta property="og:url" content="https://onedimension.net/experiment/distinct-colors/" />
  <meta property="og:title" content="Building the most visually distinct set of colors" />
  <meta
  ...
  <meta
    property="og:image"
    content="https://onedimension.net/experiment/distinct-colors/distinct-colors.gif"
  />

  <!-- Twitter -->
  <meta property="twitter:card" content="summary_large_image" />
  <meta property="twitter:url" content="https://onedimension.net/experiment/distinct-colors/" />
  <meta property="twitter:title" content="Building the most visually distinct set of colors" />
  <meta
...
<article>
  <section>
    <h1>Building the most visually distinct set of colors</h1>
    <p>
    ...
    <p>
      The answers I found weren't too satisfying; either producing sets that weren't quite right or
      methods that were much too complex. So I thought I'd play around with some of the approaches
      and gain an intuition about some of the ideas behind colorspaces, perceptual uniformity, and
      generative methods for creating colorsets.
    </p>

    <h3>Existing option: hand picked sets</h3>
    <p>
  ...
  <section>
    ...
    <p>
      The first choice we need to make is which <a
        ...
        target="_blank"
        >color space
      </a>we'll use to generate the set. This it turns out is key to answering the question of how
      different two colors appear.
    </p>
  ...
  <section>
    ...
    <p>
      These colormaps could be pregenerated and saved to speed up the palette creation process even
      more.
    </p>
    <p>
  ...
  <footer>
    ...
    <p>Thanks to Sydney Zheng for discussions and feedback throughout this experiment.</p>
    <p>
      Font is <a href="https://rsms.me/inter/" target="_blank">Inter</a>, previews are
